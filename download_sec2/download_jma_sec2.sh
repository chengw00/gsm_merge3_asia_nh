#!/bin/sh
### Configuration ###
atomURL="http://www.wis-jma.go.jp/data/syn?ContentType=Text&Resolution=1.25 1.25&Grid=Latitude/Longitude&Discipline=Global Spectral Model&Type=GRIB&Access=Open&Indicator=RJTD&Area=0.0 90.0 60.0 150.0"
userName=""
userPassword=""
limitSpeed="512k"
sleepTime="1800"
